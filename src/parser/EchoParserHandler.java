...
public class EchoParserHandler implements ParserHandler
{
    ...
    public void startOBJModel(float size, String name, String model) throws ParseException
    {
        indent++;
        for (int i = 0; i < indent; i++) System.out.print(indentString);
        System.out.println(
    ...
    public void endOBJModel() throws ParseException
    {
        for (int i = 0; i < indent; i++) System.out.print(indentString);
    ...
    public void startShape(String geometryName, String materialName, String textureName, Color3f reflection, Float refraction) throws Exception
    {
        ...
        System.out.println(
            ...
            + (reflection == null ? "" : " reflection=\"" + reflection + "\"")
            + (refraction == null ? "" : " refraction=\"" + refraction + "\"")
            + ">"
        );
    }
