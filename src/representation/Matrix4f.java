...
public class Matrix4f implements Serializable, Cloneable
{
     ...
     * @return
     */
    public static Matrix4f computeProduct(Matrix4f a, Matrix4f b)
    {
    ...
    /**
     * Compute the product of matrix and 3x1 matrix 
     * represented by a point
     * @param a matrix
     * @param b 3x1 matrix represented by a point
     * @return
     */
    public static Matrix4f computeProduct(Matrix4f a, Point3f b)
    {
        Matrix4f res = new Matrix4f();
        int x = 4;
        ...
        for(int i = 0; i < x; i++) 
        {
        	for(int j = 0; j < 1; j++) 
        	{
        		float tmp = res.getElement(i, j);
        		tmp += a.getElement(i, 0)*b.x;
        		tmp += a.getElement(i, 1)*b.y;
        		tmp += a.getElement(i, 2)*b.z;
        		tmp += a.getElement(i, 3)*1;
